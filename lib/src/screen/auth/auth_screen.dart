...
import 'package:test_flutter_angel_valdiviezo/src/utils/utils.dart';

late TextEditingController txtCorreoLog;
String numIdentAut = '';
...
class AuthScreenState extends State<AuthScreen> {
  ...
  void initState() {
    ...
    super.initState();
    txtCorreoLog = TextEditingController();
  }
        ...
        children: [
          ...
          Container(
            ...
            child: MaterialButton(
              ...
              elevation: 10,
              color: objColoresLog.naranjaDisruptive,
              child: Container(
                color: Colors.transparent,
              ...
              onPressed: () async {
                  ...
                  if(txtCorreoLog.text.isEmpty) {
                    Navigator.push(
                      context,
                      CupertinoPageRoute(
                        builder: (context) => 
                          ErrorAutenticacionErrorScreen(null,'Ingresa tu correo.','','numIdentVacia.png',false,false,'','')
                      ),
                    );
                    return;
                  }
                  ...
                  String respt = ValidacionesUtils().validaCorreo(txtCorreoLog.text);
                  ...
                  if (respt.toLowerCase() == 'ok') {
                    ...
                    Navigator.pushReplacement(
                      context,
                      CupertinoPageRoute(builder: (context) => ContraseniaScreen(correoUser: txtCorreoLog.text)),
                    );
                  } 
                  else {
                    if(!autenticacionService.objClienteValido!.succeeded) {
                      ...
                      Navigator.push(
                        ...
                        CupertinoPageRoute(
                          builder: (context) => 
                            ErrorAutenticacionErrorScreen(null,objMensajesAutenticacion.mensajeErrorInicioSesion,'','numIdentValido.png',false,false,'','')
                        ),
                      );
                    } else {
                      // ignore: use_build_context_synchronously
                      Navigator.push(
                        ...
                        CupertinoPageRoute(
                          builder: (context) => 
                            ErrorAutenticacionErrorScreen(null,objMensajesAutenticacion.mensajeErrorIdentificacion,'','numIdentValido.png',false,false,'','')
                        ),
                      );
                    }
                  }
            ...
            child: Container(
              ...
              child: MaterialButton(
                child: Container(
                  ...
                  child: AutoSizeText(
                    'Quiero suscribirme',
                    style: TextStyle(color: objColoresLog.naranjaDisruptive),
                    maxLines: 2,
