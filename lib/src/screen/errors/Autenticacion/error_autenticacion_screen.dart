...
class ErrorAutenticacionErrorScreen extends StatefulWidget {

  static const String routerName = 'autenticacionErrorScreen';
 

  ErrorAutenticacionErrorScreen(Key? key, String msmError1, String msmError2, String imgFondo, bool navegaLogin, bool errorAct, String numIdent, String varCorreo) : super (key: key){
  ...
  @override
  ErrorAutenticacionErrorScreenState createState() => ErrorAutenticacionErrorScreenState();

}

class ErrorAutenticacionErrorScreenState extends State<ErrorAutenticacionErrorScreen>{
